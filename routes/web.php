...
Route::group(['namespace' => 'Frontend', 'as'=>'frontend.'], function() {
	...
	Route::get('/outcomes/maternal/load-period-wise-data', 'OutcomeController@loadPeriodWiseMaternalData')->name('outcomes.maternal.load-period-wise-data');

	// Output Child
	Route::get('/outcomes/child', 'OutcomeController@indexChild')->name('outcomes.child');
	Route::get('/outcomes/child/load-period-wise-data', 'OutcomeController@loadPeriodWiseChildData')->name('outcomes.child.load-period-wise-data');
