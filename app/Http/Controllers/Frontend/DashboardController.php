...
class DashboardController extends Controller
{
	...
	public function indexAction() {
		...
		// dd($standards);
		return view('frontend.dashboard.index', compact('sidebarContents', 'outcomes', 'organisation_units', 'periods', 'maternal_nutrition_data', 'child_nutrition_data', 'standards'));
	}
